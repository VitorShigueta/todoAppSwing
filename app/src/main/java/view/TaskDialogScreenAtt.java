 ...
 * @author Windows 10
 */
public class TaskDialogScreenAtt extends javax.swing.JDialog {

    TaskController controller;
    Task task;
    
    public TaskDialogScreenAtt(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        try {
           if(jTextFieldName.getText().isEmpty() || jFormattedTextFieldPrazo.getText().isEmpty()) {
               JOptionPane.showMessageDialog(rootPane, "Existem camps obrigatórios não preenchidos");
                ...
                JOptionPane.showMessageDialog(rootPane, "Task alterada com sucesso");
                this.dispose();
           }
        } catch (Exception e) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TaskDialogScreenAtt.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TaskDialogScreenAtt dialog = new TaskDialogScreenAtt(new javax.swing.JFrame(), true);
    ...
    public void setInfos() {
        ...
        jFormattedTextFieldPrazo.setText(deadline);
    }
}
